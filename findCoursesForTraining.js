...
function findWeekendTrainingCourses(array,key,value) {
   return _.filter(array, [key, value]);
}
function findWeekdayTrainingCourses(array, key, value) {
    return _.filter(array, item => _.get(item, key) === value);
}
function findparttimeTrainingCourses(array, key, value) {
    return _.find(array, item => item[key] === value);
}
...
console.log("Weekday Training Courses", findWeekdayTrainingCourses(trainingBatchJson, 'batchType', 'WEEKDAYBATCH'));
console.log("Weekend Training Courses", findWeekendTrainingCourses(trainingBatchJson, 'batchType', 'WEEKENDBATCH'));
console.log("partTime Training Courses", findparttimeTrainingCourses(trainingBatchJson, 'batchType', 'PARTTIMEBATCH'));
